                ...
                <thead>
                    <tr>
                        <td colSpan="2">
                            ...
                            {/* <div class="input-group" style={{ width: '160px',  marginBottom: '10px'}} >
                                <input type="text" className="form-control form-control-sm" placeholder="name" onChange={this.changeInput}></input>
                            </div> */}
                        </td>
                    </tr>
                </thead>
